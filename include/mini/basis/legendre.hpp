...
#ifndef MINI_BASIS_LEGENDRE_HPP_
#define MINI_BASIS_LEGENDRE_HPP_
...
template <int kDegree>
constexpr algebra::Column<double, kDegree+1> legendre_array(double x) {
  algebra::Column<double, kDegree+1> result;
  result[0] = 1.0;
...
#endif  //  MINI_BASIS_LEGENDRE_HPP_
