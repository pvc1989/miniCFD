...
class TestLagrangeBasis : public ::testing::Test {
 protected:
  using Scalar = double;
...
TEST_F(TestLagrangeBasis, KroneckerDeltaProperty) {
...
TEST_F(TestLagrangeBasis, PartitionOfUnityProperty) {
  auto lagrange = GetRandomLagrange();
...
TEST_F(TestLagrangeBasis, GetDerivatives) {
